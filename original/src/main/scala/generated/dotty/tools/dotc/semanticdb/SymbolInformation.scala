...
object SymbolInformation  {
  ...
  sealed abstract class Kind(val value: _root_.scala.Int)  extends SemanticdbGeneratedEnum {
    type EnumType = Kind
  ...
  sealed abstract class Property(val value: _root_.scala.Int)  extends SemanticdbGeneratedEnum {
